...
GO
/****** Object:  StoredProcedure [dbo].[usp_SearchUserAdminWithoutDirectReply]    Script Date: 7/14/2023 12:04:26 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
ALTER procedure [dbo].[usp_SearchUserAdminWithoutDirectReply]
 @RowsPerPage INT = 10,
 @PageNumber as INT = 1,
...
declare @tempuser as table
 ...
 INSERT INTO @UserWithDirectReply
	select RecepientID from UserMessage where IsDirectReply = 1 group by RecepientID
 ...
 (
  ...
  AND U.UserID not in (select UserID from @UserWithDirectReply)
 )
