<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MyRoom.aspx.cs" Inherits="Language.Discovery.MyRoom" meta:resourcekey="PageResource1" MaintainScrollPositionOnPostback="true" culture="auto" uiculture="auto" ValidateRequest="false" EnableEventValidation="false" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server" enctype="multipart/form-data">
    ...
    <link href="../App_Themes/Default/MyRoom.css?v=1" rel="stylesheet" type="text/css" />
	...
	<script type="text/javascript">
        ...
        function SelectColor(el) {
            let postfix = "_en";
            let skin = $(el).data("color");
            if ($('#hdnLanguage').val() == "ja-JP") {
                postfix = "_jp";
            }
            if (skin.indexOf('solid') < 0) {
                postfix = "";
            }

            ChangeSkin($(el).data("color") + postfix + ".png");
            $('#hdnSkin').val($(el).attr("data-color") + postfix + ".png");
            //$.modal.close();
            //$('#btnReload').click();
        }
            ...
            var dlg = $("#prof_bottom_container").dialog({
                ...
                buttons: [{
                    ...
                    click: function (e) {
                        ...
                        //var isValid = validationExpression.test($("#txtPassword").val());
                        //isValid = ($('#cvConfirmPassword').css("visibility") == "hidden");
                        var isValid = Page_ClientValidate("p");
        ...
        $(function () {
            ...
            $('.hotspot-container').click(function () {
                showProfile(); 
        ...
        function showMyRoomQuickGuide() {
            
            showProfile();
           
            //$('#frmQuickGuide').attr("src", $('#hdnQuickStart').val());
            //var height = isMobile() ? 420 : isTablet() ? 520 : 520;
            //var width = isMobile() ? 640 : isTablet() ? 720 : 831;

            //var fheight = isMobile() ? 300 : isTablet() ? 400 : 400;
            //var fwidth = isMobile() ? 600 : isTablet() ? 700 : 800;

            //$('#frmQuickGuide').attr("width", fwidth);
            //$('#frmQuickGuide').attr("height", fheight);
            //$("#divMyRoomQuickGuide").dialog({
            //    autoOpen: true,
            //    width: width,
            //    height: height,
            //    position: ['center', 'center'],
            ...
            //    $("#divMyRoomQuickGuide").dialog("close");
            //});
   ...
   <%-- <div id="divMyRoomQuickGuide" style="display: none;">
        <div id="divFrameQuickGuide">
            <iframe height="400" width="400" src="" frameborder="0" allowfullscreen rel="0&amp;showinfo=0" id="frmQuickGuide"></iframe>
        </div>
        <div id="divchkDontShowQuickGuide">
            <asp:CheckBox ID="chkDontShowQuickGuide" runat="server" ClientIDMode="Static" Visible="false" />&nbsp;<asp:Label ID="lblDontShowQuickGuide" runat="server" Visible="false" ClientIDMode="Static" meta:resourcekey="lblDontShowQuickGuideResource1">Don't display this again.</asp:Label>
            <button id="btnOk" style="float:right">Ok</button>
        </div>
    </div>--%>

    <asp:HiddenField ID="hdnQuickStart" runat="server" ClientIDMode="Static" meta:resourcekey="hdnQuickStartResource1"/>
	...
	<div class="profile_left_Container" id="profile_left_Container">
        ...
        <div class="prof_top_container" id="prof_top_container">
			...
			<div class="prof_top_con_txtupdatemystatus" id="prof_top_con_txtupdatemystatus">
				<asp:TextBox ID="txtStatus" CssClass="prof_top_con_txtupdatemystatus_box" runat="server" TextMode="MultiLine" meta:resourcekey="txtStatus" ClientIDMode="Static" AutoComplete="off" AutoCompleteType="Disabled" spellcheck="true"></asp:TextBox><span id="spanStatus" style="display:initial;"><img class="prof_top_con_txtupdatemystatus_boxcheck" src="../Images/check.png"/></span>
            ...
            <div id="divPhotoContainer">
                ...
                <asp:Button ID="btnAddPhoto" CssClass="btnAddPhoto" Height="44px" BorderStyle="None" Width="194px"  runat="server" ClientIDMode="Static" Text="" OnClick="btnAddPhoto_Click" Visible="false" />
            </div>
		</div>
        <div class="lblLikeCount">
			...
			<div class="prof_left_top" id="prof_left_top">
				<div id="changemyroom">
                    <div id="divMyRoomButtonContainer">
	...
	<div class="profile_right_Container" id="profile_right_Container">
		...
		<div class="prof_bottom_container" id="prof_bottom_container"  style="display:none;">
			...
			<div class="tcp_lbl_title_container">
				<asp:Label ID="lblAboutMe" runat="server" Text="This will help new friends find you." style="display:none;" meta:resourcekey="lblAboutMeResource1"></asp:Label>  
			</div>
						...
						<div id="tab1" class="panel_profile">
							<div class="tabl_container_profile">
								...
								<div class="tcp_lbl_title_container">
									...
									<asp:CompareValidator ID="cfvGrade" runat="server" ErrorMessage="Grade is Required" ValidationGroup="p" ForeColor="Red" Display="Dynamic" ClientIDMode="Static" meta:resourcekey="cfvGradeResource1"  Operator="NotEqual" ValueToCompare="0" ControlToValidate="ddlGrade">*</asp:CompareValidator>
								</div>
								<div class="tcp_lbl_title">
								...
								<div class="tcp_lbl_title_container">
									<div id="divPassword" style="display:none;width:100%;" >
										<div id="divReminder" style="width: 352px; border: 1px solid red;margin-left:3px;">
											<asp:Label ID="lblReminder" runat="server" Text="Password must be at least 8 characters, mix of letters and numbers." ForeColor="red" meta:resourcekey="lblReminderResource1"></asp:Label>
										</div>
										<div>
											...
											<asp:TextBox ID="txtPassword" TextMode="Password" runat="server" meta:resourcekey="txtPasswordResource1" ClientIDMode="Static"></asp:TextBox>
											...
											<asp:RegularExpressionValidator ID="revPassword" ControlToValidate="txtPassword" ValidationGroup="p" ForeColor="Red" ClientIDMode="Static"
												...
												runat="server" ErrorMessage="Your password is weak. Please check the note above for strong password guide.">*
											...
											<asp:TextBox ID="txtConfirmPassword" TextMode="Password" runat="server" meta:resourcekey="txtConfirmPasswordResource1" ClientIDMode="Static"></asp:TextBox>
                                    ...
                                    <div>
									<asp:ValidationSummary ID="ValidationSummary1" runat="server" ValidationGroup="p" BorderColor="Red" BorderStyle="Solid" BorderWidth="1px" ClientIDMode="Static"  HeaderText="" ForeColor="Red" Width="200px" meta:resourcekey="ValidationSummary1Resource1" />
                                    </div>
								</div>
							</div>
						</div>
        ...
        <div id="divThemes" class="modal" style="display:none;">
            <div id="divThemesTitle">
                <span id="lblThemeLabel">Choose your room theme</span>
            </div>
            <div id="innerDivThemesContainer">
                <div id="zeroRow" class="rows">
                    <div class="divColorContainer">
                        <div id="japaneseRoom1" class="theme solidThemes" data-color="solid_japaneseRoom" style="background-image: url('../Images/skin/myroom/Japanese.png'); background-position:center; background-size: contain;background-repeat: no-repeat;  top: 61px;" onclick="SelectColor(this);" >
                            <div class="innerTheme" style="background-color:red;color:red;display:none;"></div>
                            <label style="top: 61px;display:none;">Japanese Room</label>
                        </div>
                        <div id="australiaRoom1" class="theme solidThemes" data-color="solid_australiaRoom" style="background-image: url('../Images/skin/myroom/Aus.png'); background-position:center; background-size: contain;background-repeat: no-repeat;  top: 61px;" onclick="SelectColor(this);" >
                            <label style="top: 61px;display:none;">Australian Room</label>
                        </div>
                        <div id="basketball1" class="theme solidThemes" data-color="solid_basketball" style="background-image: url('../Images/skin/myroom/Basketball.png'); background-position:center; background-size: contain;background-repeat: no-repeat;  top: 61px;" onclick="SelectColor(this);" >
                            <label style="top: 61px;display:none;">Basketball Room</label>
                        </div>
                        <div id="tennis1" class="theme solidThemes" data-color="solid_TennisRoom" style="background-image: url('../Images/skin/myroom/Tennis.png'); background-position:center; background-size: contain;background-repeat: no-repeat;  top: 61px;" onclick="SelectColor(this);" >
                            <label style="top: 61px;display:none;">Tennis Room</label>
                        </div>
                        <div id="rugby1" class="theme solidThemes" data-color="solid_RugbyRoom" style="background-image: url('../Images/skin/myroom/Rugby.png'); background-position:center; background-size: contain;background-repeat: no-repeat;  top: 61px;" onclick="SelectColor(this);" >
                        </div>
                        <div id="foorball1" class="theme solidThemes" data-color="solid_FootballRoom" style="background-image: url('../Images/skin/myroom/Soccer.png'); background-position:center; background-size: contain;background-repeat: no-repeat;  top: 61px;" onclick="SelectColor(this);" >
                        </div>
                    </div>
                </div>
