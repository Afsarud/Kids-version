...
<![endif]-->
    <script type="text/javascript">
        ...
        $(function () {
            ...
            //    Translate(sl, tl, $("#txtFreeMessage1").val(), $("#txtFreeMessage2"), 'freemessage');
            //});
            Translate('en', 'ja', 'the quick brown fox jumps over the lazy dog', 'the quick brown fox jumps over the lazy dog', 'freemessage');
            AppendCircleButton();
...
<%--        <asp:HiddenField ID="hdnParentsInfoFlag" runat="server" ClientIDMode="Static" />
      ...
      <%-- <div id="divParentsInfo" style="display:none;">
        ...
        <div id="top_container">
                <div id="divTalkScheduleContainer">
                    
                    <div id="divAvailableTimesContainer">
                    ...
                    <div id="divAvailableScheduleContainer" style="display:none;">
                    ...
                    <div id="divActionContainer">
                        <div id="divActionInnerContainer">
                            <img class="actionButton" id="imgTalkChecklist" src="../Images/new/E_TalkChecklist_new.png" onclick="talkChecklist();" />
                            <img class="actionButton disableHeaderMenu" id="imgTestCamera" src="../Images/new/E_CameraAndMicTest_new.png" onclick="TestCamera();" />
                            <img class="actionButton" id="imgTestSound" src="../Images/new/E_SoundTest_new.png" onclick="TestSound();" />
                            <img class="actionButton" id="imgGoToScheduler" src="../Images/new/E_ScheduleTalk_new.png" onclick="gotoScheduler();" />
                            <img class="actionButton" id="imgInstructionVideo" src="../Images/new/E_InstructionVideo_new.png" onclick="OpenYouTube('hdnTalkTutorial');" />
                ...
                <div id="renderer1" style="display:none;"></div>
                 <div class="sendmsg_top_container" id="sendmsg_top_container" >
                        ...
                        <%--<input type="text" id="txtSearchFriend" style="width:242px;font-size: smaller;border-radius: 4px;" placeholder="Search by name, username, location, status" />--%>
                                                ...
                                                <div class="divUser_avatar_info" id="divUser_avatar_info">
                                                    ...
                                                    <div class="statusContainer">
                                                        <div class="ontalk" title='<%#  Eval("IsCanTalk").ToString() %>'>
                                                            ...
                                                            <img src='<%#  Convert.ToBoolean(Eval("IsCanTalk")) ?  "../Images/new/online.png" : "../Images/new/offline.png"%>' id="imgOnTalkStatus"/>
                                                        </div>
                                                    </div>
                                                </div>
                ...
                <div id="callContainer">
                    ...
                    <div id="divCall"  style="display:none;">
                        <img src="../Images/new/CallingStatic.png" id="btnCallIcon" class="btnCallIconDisabled"  onclick="CreateAndJoinConference(event);"/>
                    </div>
                ...
                <div id="divMessageContainer">
                    <div class="smctc_msgbox_btnaddclear_container">
                     ...
                     <div id="divChatBoxLabecontainer">
                         ...
                         <asp:Label ID="lblChatBox" ClientIDMode="Static" runat="server" Text="Chat Box" meta:resourcekey="lblChatBoxLabelResource1"></asp:Label>
                     </div>
                                        ...
                                        <HeaderTemplate>
                                            ...
                                            <ItemTemplate>
                                                <tr runat="server" id="trMessage"  data-keyword='<%# Eval("Keyword") %>'>
                                                    <td class="nameContainer" style="vertical-align:middle;width:13%">
                                                        <asp:Label runat="server" id="lblYou" class="partner chatname" style="color:red;font-size:8pt;font-weight:bold;" Text='<%# Eval("Sender") %>' Visible="false"></asp:Label>
                                                        <asp:Label runat="server" id="lblMe" class="chatname" style="color:black;font-size:8pt;font-weight:bold;" Text='<%# Eval("Sender") %>' Visible="false"></asp:Label>
                    ...
                    <div id="divToolsContainer" class="divToolsContainer">
                        <div id="divImReady" class="square">
                        ...
                        <div id="divRepeatImage" class="square">
                        ...
                        <div id="divTextMeImage" class="square">
                        ...
                        <div id="divFreeMessageImage" class="square" runat="server" ClientIDMode="Static" onclick="FreeMessage(); return false;">
            ...
            <div id="mtabs">
                <div class="smc_criteria_container" id="smc_criteria_container">
                    ...
                    <ul class="tabs_links_menu">
						...
						<li id="liTabWordForPhrase" class="wordTab" style="background: #c9e265 !important;"><asp:HyperLink CssClass="send-msg-tabs5" ID="HyperLink4" href="#mtab5" runat="server" Text="Word" meta:resourcekey="linkTabWordResource1"/></li>
                    ...
                    <div class="divAddOwnPaletteContainer">
                        ...
                        <%--<asp:Button ID="btnAddOwnPalette" ClientIDMode="Static" CssClass="btnUpdate_profile btnAddOwnPalette" runat="server" Text="Save selected palette to My Phrases" OnClientClick="return false;"  meta:resourcekey="btnAddOwnPaletteResource1" UseSubmitBehavior="false" CausesValidation="false"/> --%>
                    </div>
            ...
            <div id="mtab3">
                <div class="sbc_right_container" id="sbc_right_container">
                    <div class="src_frame">
                        ...
                        <div class="switch_container">
                            <div class="sc_lbl">
                                <asp:Label ID="lblSoundAndMail" runat="server" Text="Sound and Mail/Mail Only" meta:resourcekey="lblSoundAndMailResource1"></asp:Label>
                            </div>
                            <div class="sc_conf">
                        ...
                        <div id="mtab5">
                            ...
                            <div id="divWordPaletteOtherContainer1">
                                ...
                                <div class="steptitlepagingContainer centerElementContainer" style="display:none;">
                                    ...
                                    <asp:Label ID="lblLabelWordPaging" runat="server" Text="Word palette" meta:resourcekey="lblLabelWordPagingResource1" style="line-height:24px;text-align:center;font-weight:bold;" ></asp:Label>
                                </div>
                                <div class="steptitlepagingContainer">
