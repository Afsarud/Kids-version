<%@ Page Title="" Language="C#" MasterPageFile="~/Master/AdminMaster.Master" AutoEventWireup="true" CodeBehind="MailExhangeStatistics.aspx.cs" Inherits="Language.Discovery.Admin.MailExhangeStatistics" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <div style="width:100%;border:1px solid black;text-align:center;">
        <asp:Label ID="lblTitle" runat="server" Text="Mail Exchange Statistics Report" meta:resourcekey="lblTitleResource1"></asp:Label>
    </div>
</asp:Content>
