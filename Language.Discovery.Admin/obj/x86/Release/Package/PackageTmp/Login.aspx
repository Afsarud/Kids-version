        ...
        <table class="CenteredPage">
		    <tr>
			    ...
			    <td style="text-align: left"><asp:TextBox ID="txtUsername" runat="server" MaxLength="50" TabIndex="1" Width="150px" CssClass="LoginField" meta:resourcekey="txtUsernameResource1" ClientIDMode="Static"></asp:TextBox>
			        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Please input your User Name." ControlToValidate="txtUsername" meta:resourcekey="RequiredFieldValidator2Resource1">*</asp:RequiredFieldValidator>
			    </td>
		    </tr>
		    <tr>
			    ...
			    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Please input your Password." ControlToValidate="txtPassword" meta:resourcekey="RequiredFieldValidator1Resource1">*</asp:RequiredFieldValidator>
			    </td>
		    </tr>
		    <tr>
			    <td>
