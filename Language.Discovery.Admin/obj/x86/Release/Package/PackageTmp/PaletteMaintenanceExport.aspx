                    ...
                    <legend><asp:Label ID="lblLegend" runat="server" Text="Search" meta:resourcekey="lblLegendResource1"></asp:Label></legend>
                        <table>
                            <tr>
                                <td>
                                    <fieldset>
                                        ...
                                        <asp:RadioButtonList runat="server" id="rdoAction" RepeatDirection="Vertical" RepeatLayout="Table" OnSelectedIndexChanged="rdoAction_OnSelectedIndexChanged" AutoPostBack="True" ClientIDMode="Static">
                            ...
                            <td colspan="2">
                                ...
                                <asp:Label ID="lblWarning" runat="server" Visible="False" Font-Bold="True" ForeColor="red" EnableViewState="false">PLEASE WAIT FOR 5-10 MINUTES. <BR> THE IMPORT IS RUNNING IN THE BACKGROUND <BR> PLEASE DO NOT ACCESS YET THE PALETTE SETTINGS PAGE AND THE MAIL CREATION PAGE.</asp:Label><br />
                            </td>
                            </tr>
                           <tr class="category">
                                ...
                                <td><asp:DropDownList ID="ddlSearchCategory" runat="server" meta:resourcekey="ddlSearchCategoryResource1"></asp:DropDownList>
                                    <asp:CompareValidator ID="CompareValidator1" ClientIDMode="Static"  runat="server" ErrorMessage="Category is required." ControlToValidate="ddlSearchCategory" ValueToCompare="0" Operator="NotEqual"  ForeColor="Red">Category is Required</asp:CompareValidator>
                                </td>
                            </tr>
                            <tr>
                                <asp:RadioButtonList runat="server" id="rdoImportActionList" RepeatDirection="Vertical" RepeatLayout="Table" Visible="false">
                                    <asp:ListItem Text="Replace All Palette in Category Selected" Value="0" Selected="True"></asp:ListItem>
									<asp:ListItem Text="Add Palette in Category Selected" Value="1"></asp:ListItem>
                                </asp:RadioButtonList>
                            </tr>
                            <tr>
                                <td><asp:Button ID="btnExport" runat="server" Text="Export" OnClick="btnExport_OnClick"/></td>
                                <td><asp:Button ID="btnImport" runat="server" Text="Import" OnClick="btnImport_OnClick"/></td>
                            </tr>
                    </table>
                </fieldset>
            </ContentTemplate>  
