<%@ Page Title="" Language="C#" MasterPageFile="~/Master/AdminMaster.Master" AutoEventWireup="true" CodeBehind="LoginReport.aspx.cs" Inherits="Language.Discovery.Admin.LoginReport" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <div style="width:100%;border:1px solid black;text-align:center;">
        <asp:Label ID="lblTitle" runat="server" Text="User Login Report" meta:resourcekey="lblTitleResource1"></asp:Label>
    </div>
     ...
     <asp:HiddenField ID="hdnAll" runat="server" meta:resourcekey="hdnAllResource1" />
      ...
      <table>
        <tr>
            ...
            <td><asp:Label ID="Label1" runat="server" meta:resourcekey="Label1Resource1" Text="User"></asp:Label></td>
