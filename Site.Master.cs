        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    linkPrivacy.Text = HttpContext.GetGlobalResourceObject("SiteMaster.master", "linkPrivacy").ToString();
                    linkPrivacy.NavigateUrl = HttpContext.GetGlobalResourceObject("SiteMaster.master", "linkPrivacyUrl").ToString();
                    lblUserNameLabel.Text = HttpContext.GetGlobalResourceObject("SiteMaster.master", "lblUserNameLabel").ToString();
                    lblChildrensFirstName.Text = HttpContext.GetGlobalResourceObject("SiteMaster.master", "lblChildrensFirstName").ToString();
                    lblParentsName.Text = HttpContext.GetGlobalResourceObject("SiteMaster.master", "lblParentsName").ToString();
                    lblParentsEmail.Text = HttpContext.GetGlobalResourceObject("SiteMaster.master", "lblParentsEmail").ToString();
                    lblFinalUserNameLabel.Text = HttpContext.GetGlobalResourceObject("SiteMaster.master", "lblFinalUserNameLabel").ToString();
                    lblChildrensFirstNameError.Text = HttpContext.GetGlobalResourceObject("SiteMaster.master", "lblChildrensFirstNameError").ToString();
                    lblParentsNameError.Text = HttpContext.GetGlobalResourceObject("SiteMaster.master", "lblParentsNameError").ToString();
                    lblParentsEmailError.Text = HttpContext.GetGlobalResourceObject("SiteMaster.master", "lblParentsEmailError").ToString();
                    lblPhoneNumberError.Text = HttpContext.GetGlobalResourceObject("SiteMaster.master", "lblPhoneNumberError").ToString();
                    hdnAgree.Value = HttpContext.GetGlobalResourceObject("SiteMaster.master", "hdnAgree").ToString();
                    lblInformation.Text = HttpContext.GetGlobalResourceObject("SiteMaster.master", "lblInformation").ToString();
                    lblParentsEmailConfirmation.Text = HttpContext.GetGlobalResourceObject("SiteMaster.master", "lblParentsEmailConfirmation").ToString();
                    lblParentsEmailConfirmationError.Text = HttpContext.GetGlobalResourceObject("SiteMaster.master", "lblParentsEmailConfirmationError").ToString();
                    lblUserNameNote.Text = HttpContext.GetGlobalResourceObject("SiteMaster.master", "lblUserNameNote").ToString();
                ...
                hdnCurrentLanguage.Value = SessionManager.Instance.SchoolProfile.NativeLanguage;
